        ...
        [HAL_PARTITION_CM33_MAIN] =
            {
                ...
                .partition_length = 0xA80000, //10752KB
                .partition_options = PAR_OPT_READ_EN | PAR_OPT_WRITE_EN,
            },
        [HAL_PARTITION_SYSTEM_MINI] =
            {
                ...
                .partition_start_addr = 0xB00000,
                .partition_length = 0x390000, //3584KB
                .partition_options = PAR_OPT_READ_EN | PAR_OPT_WRITE_EN,
            },
        [HAL_PARTITION_RESOURCE] =
            {
                ...
                .partition_start_addr = 0xE90000,
                .partition_length = 0xD0000, //832KB
                .partition_options = PAR_OPT_READ_EN | PAR_OPT_WRITE_EN,
            },
        [HAL_PARTITION_LOG] =
            {
