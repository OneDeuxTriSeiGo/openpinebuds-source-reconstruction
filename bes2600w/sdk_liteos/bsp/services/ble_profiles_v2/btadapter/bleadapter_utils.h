...
void btadapter_ble_client_start_service(adapter_client_task_env_t * task_env);
...
bool btadapter_ble_client_read_by_uuid(int32_t conidx);
...
bes_gatt_status_e btadapter_ble_client_start_char_discovery(adapter_client_task_env_t* task_env,
                                                                                                                        uint8_t conidx, 
...
bes_gatt_status_e btadapter_ble_client_start_desc_discovery(adapter_client_task_env_t* task_env,
                                                                                                                        uint8_t conidx, 
                                                                                                                        uint16_t start_hdl,
                                                                                                                        uint16_t end_hdl);
uint8_t * btadapter_ble_get_addr_by_conidx(uint8_t conidx);

void btadapter_ble_gattc_read_char(uint8_t conidx, uint16_t handle);

void btadapter_ble_gattc_read_by_uuid(uint8_t conidx, 
                                                                                        uint16_t start_handle,
                                                                                        uint16_t end_handle,
                                                                                        uint8_t uuid_len,
                                                                                        uint8_t* uuid);

void btadapter_ble_gattc_write(int32_t connId, 
                                                                       uint32_t handle, 
