...
#ifdef TRANSQ_WIFI_EXTEND
#define TRANSQ0_SLOT_NUM 52
#else
#define TRANSQ0_SLOT_NUM TRANSQ_SLOT_NUM
#endif
#if (CHIP_HAS_TRANSQ > 1)
#define TRANSQ1_SLOT_NUM TRANSQ_SLOT_NUM
#endif
...
struct TRANSQ_T
{
    ...
    } WSLOT[TRANSQ0_SLOT_NUM];
#ifndef TRANSQ_WIFI_EXTEND
    __IO uint32_t RESERVED_130[40];     // 0x130
#endif
    ...
    __IO uint32_t RESERVED_1b0[2];   // 0x1b0 //2003
    union {
