...
enum USB_SERIAL_STATE_EVENT_T {
    ...
    USB_SERIAL_STATE_TERMINAL_CONNECTED,
    USB_SERIAL_STATE_TERMINAL_DISCONNECTED,
};
...
enum USB_SERIAL_LINE_STATE_T {
    USB_SERIAL_LINE_STATE_DCD           = (1 << 0),
    USB_SERIAL_LINE_STATE_DSR           = (1 << 1),
    USB_SERIAL_LINE_STATE_BREAK         = (1 << 2),
    USB_SERIAL_LINE_STATE_RING          = (1 << 3),
    USB_SERIAL_LINE_STATE_FRAMING_ERR   = (1 << 4),
    USB_SERIAL_LINE_STATE_PARITY_ERR    = (1 << 5),
    USB_SERIAL_LINE_STATE_OVERRUN_ERR   = (1 << 6),
};
...
int usb_serial_state_notif_busy(void);

void usb_serial_cancel_state_notif(void);

int usb_serial_break_set(void);

int usb_serial_break_clear(void);

// Auto clear break signal
